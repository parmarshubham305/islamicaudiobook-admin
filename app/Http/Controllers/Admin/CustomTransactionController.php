...
class CustomTransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $expiry = CustomTransaction::where('status', 1)->get();
            ...
            $params['data'] = [];
            if ($request->ajax()) {
                $data = CustomTransaction::select('*')->with('customPackage','user')->latest()->get();
            ...
            return view('admin.custom-transaction.index', $params);
        } catch (Exception $e) {
    ...
    public function create(Request $request)
    {
        try{
            ...
            return view('admin.custom-transaction.add',$params);
    ...
    public function store(Request $request)
    {
        try{
            ...
            if ($validator->fails()) {
                ...
                $Transction = new CustomTransaction();
