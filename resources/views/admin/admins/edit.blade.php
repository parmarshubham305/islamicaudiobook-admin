						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="text" value="@if($data){{$data->user_name}}@endif" name="user_name" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('label.enter_your_name')}}">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="email" value="@if($data){{$data->email}}@endif" name="email" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('label.enter_your_email')}}">
								</div>
							</div>
						</div>
						...
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="number" value="@if($data){{$data->phone_number}}@endif" name="phone_number" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('+91 1234567890')}}">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="number" value="@if($data){{$data->account_number}}@endif" name="account_number" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('1234567890')}}">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="text" value="@if($data){{$data->ifsc_code}}@endif" name="ifsc_code" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('Enter IFSC code')}}">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="text" value="@if($data){{$data->branch_code}}@endif" name="branch_code" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('Enter Branch code')}}">
								</div>
							</div>
						</div>
						<div class="form-row">
						...
						<div class="form-row" id="itin_number">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="number" value="@if($data){{$data->itin_number}}@endif" name="itin_number" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('Enter ITIN number')}}">
								</div>
							</div>
						</div>
						<div class="form-row" id="ein_number">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<input type="number" value="@if($data){{$data->ein_number}}@endif" name="ein_number" {{$data->permissions_role == 'super_admin'  ? 'readonly' : ''}} class="form-control" placeholder="{{__('Enter Ein Number')}}">
								</div>
							</div>
						</div>
						@endif
