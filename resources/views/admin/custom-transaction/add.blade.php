            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('custom-transaction.index') }}">Transaction</a>
                        </li>
                ...
                <form enctype="multipart/form-data" id="search_user">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="{{route('custom-transaction.create')}}" class="btn btn-cancel mw-120">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
@section('pagescript')
    <script type="text/javascript">
        function add_transaction() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("custom-transaction.store") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'add_transaction', '{{ route("custom-transaction.index") }}');
                },
