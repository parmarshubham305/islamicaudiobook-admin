        ...
        <div class="body-content">
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('custom-transaction.create') }}" class="btn btn-default mw-120" style="margin-top:-14px">Add Transaction</a>
                </div>
            </div>
        ...
        $(document).ready(function() {
            $(function () {
                var table = $('#datatable').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('custom-transaction.index') }}",
                    columns: [
                    ...
                    {data: 'custom_package.name', name: 'title', orderable: false,
                        "render": function (data, type, full, meta) {
                        if(data) {
                            return data;
                        } else {
