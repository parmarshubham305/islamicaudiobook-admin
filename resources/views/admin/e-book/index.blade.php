...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-xl-3">
      <a href="{{ route('e-book.create') }}" class="add-video-btn">
            ...
            <div class="card-details">
              ...
              <div class="dropdown dropright">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="{{ route('e-book.edit', [$value->id])}}">
                          <img src="{{ asset('assets/imgs/edit.png') }}" class="dot-icon" />
                             Edit
                      </a>
                      <a class="dropdown-item" href="{{ route('e-book.deleteEBook', $value->id)}}" onclick="return confirm('Are You Sure Delete This E-Book?')">
