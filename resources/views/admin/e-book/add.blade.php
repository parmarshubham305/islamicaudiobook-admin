...
@section('page_title',  __('Add E-Book'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Add E-Book</h1>
            ...
            <div class="card custom-border-card mt-3">
                <div class="card-body">
                    <form enctype="multipart/form-data" id="e-book" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="e-book" role="tabpanel" aria-labelledby="audio-tab">
                        ...
                        <div class="border-top mt-2 pt-3 text-right">
                            <button type="button" class="btn btn-default mw-120" onclick="save_e_book()">{{__('label.save')}}</button>
...
@section('pagescript')
	...
	<script>
		...
		function save_e_book(){
			$("#dvloader").show();
			var formData = new FormData($("#e-book")[0]);
			$.ajax({
				type:'POST',
