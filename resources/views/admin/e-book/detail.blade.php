...
@section('page_title',   __('E-Book Detail'))
@section('content')
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('e-book.index') }}"> {{ __('E-Book') }}</a></li>
                    <li class="breadcrumb-item"><a href="">{{__('label.details')}}</a></li>
                </ol>
            </div>
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('e-book.index') }}" class="btn btn-default mw-120" style="margin-top: -14px;">{{__('label.e_book')}}</a>
            </div>
        </div>
