@extends('layout.page-app')
    ...
    @section('page_title',  __('Edit AI Audio Book'))
    ...
    @section('content')
        ...
        <div class="right-content">
            ...
            <div class="body-content">
                <!-- mobile title -->
                <h1 class="page-title-sm">{{__('Edit AI Audio Book')}}</h1>
                <div class="border-bottom row mb-3">
                    <div class="col-sm-10">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('aiaudiobook.index') }}">AI Audio Book</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">
                                {{__('Edit AI Audio Book')}}
                            </li>
                        </ol>
                    </div>
                    <div class="col-sm-2 d-flex align-items-center justify-content-end">
                        <a href="{{ route('aiaudiobook.index') }}" class="btn btn-default mw-120" style="margin-top:-14px">{{__('AI Audio List')}}</a>
                    </div>
                </div>
